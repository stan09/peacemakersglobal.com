...
<head>
    <title><? echo lang('login'); ?> | peacemakers</title>
    <meta charset="UTF-8">
    <meta name="description" content="peacemakers is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="login,social network,social media,peacemakers,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">peacemakers</a>
