...
<head>
    <title><? echo lang('welcome'); ?> | peacemaker's</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="homepage,main,login,social network,social media,peacemaker's,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">peacemaker's</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> peacemaker's</h3>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="peacemaker's" style="width: 300px;" />
                </div>
            </div>
        </div>
